 ...
 * @package TM\Rdio\Type
 */
class CollectionAlbum extends Base
{
    /**
    ...
    /**
     * track keys for all tracks on the album
     *
     * @SerializedName("itemTrackKeys")
     * @Type("array<string>")
     *
     * @var string[]
     */
    protected $itemTrackKeys;

    /**
     * the key of the artist outside the context of the collection
     *
     * @SerializedName("rawArtistKey")
     * @Type("string")
     *
     * @var string
     */
    protected $rawArtistKey;
    ...
    /**
     * the gender of the user whose collection this album is in
     *
    ...
    /**
     * @param \string[] $itemTrackKeys
     */
    public function setItemTrackKeys($itemTrackKeys)
    {
        $this->itemTrackKeys = $itemTrackKeys;
    }

    /**
     * @return \string[]
     */
    public function getItemTrackKeys()
    {
        return $this->itemTrackKeys;
    }
    ...
    /**
     * @param string $rawArtistKey
     */
    public function setRawArtistKey($rawArtistKey)
    {
        $this->rawArtistKey = $rawArtistKey;
    }

    /**
     * @return string
     */
    public function getRawArtistKey()
    {
        return $this->rawArtistKey;
    }
